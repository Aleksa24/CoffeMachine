...
public class FormMain extends javax.swing.JDialog implements DocumentListener {
    ...
    private void initComponents() {
        ...
        jMenuKasa = new javax.swing.JMenu();
        jMenuItemKasa = new javax.swing.JMenuItem();
        ...
        jMenuKasa.setText("Kasa");

        jMenuItemKasa.setText("iznos");
        jMenuItemKasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemKasaActionPerformed(evt);
            }
        });
        jMenuKasa.add(jMenuItemKasa);

        jMenuBar1.add(jMenuKasa);
    ...
    private void btnMakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeActionPerformed
        try {
            ...
            chain.getCurrency(new Currency(Integer.parseInt(txtReturns.getText().trim())), map,kasa);
    ...
    private void jMenuItemKasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemKasaActionPerformed
         new FKasa(null, true, kasa).setVisible(true);
    }//GEN-LAST:event_jMenuItemKasaActionPerformed
    ...
    private javax.swing.JMenuItem jMenuItemKasa;
    private javax.swing.JMenu jMenuKasa;
    ...
    private void checkEnoughMoney() throws Exception {
        ...
        if(ukupnoKasa() < Integer.parseInt(txtReturns.getText())){
            throw new Exception("Not enough to return");
        }
    }
    ...
    private void fillKasa() {
        kasa = new HashMap<String,Integer>(){
            {
                put("100",3);
                put("50", 3);
                put("20", 8);
    ...
    private int ukupnoKasa() {
        int value = 0;
        value += kasa.get("100")*100;
        value += kasa.get("50")*50;
        value += kasa.get("20")*20;
        value += kasa.get("1")*1;
